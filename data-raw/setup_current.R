...
sdmx_file <- "downloads/xmlfile_APR2025.xml"
...
# make a list
data_2504 <- weo_df %>% 
  replace_na(list(scale = 1)) # avoid NAs in scale, though no NAs in 2504
...
# save
usethis::use_data(data_2504, menu, meta, overwrite = TRUE)
